...
import CurologyProduct from "../assets/CurologyProduct.svg";
import MercedesBenz from "../assets/MercedesBenz.svg";
import SoccerCleat from "../assets/SoccerCleat.svg";
import USBGamepad from "../assets/USBGamepad.svg";
import SaintJacket from "../assets/SaintJacket.svg";
...
const Product = () => {
  return (
    <div className=" mb-28">
      ...
      <div className="grid grid-cols-4 lg:grid lg:grid-cols-3 lg:place-items-center md:grid-cols-2 md:grid md:place-items-center xs:flex sm:flex  xs:flex-col sm:flex-col xs:items-center sm:items-center xs:mt-4">
        <NewItemCard
          review={true}
          wishlist={true}
          imageSrc={DogFood}
